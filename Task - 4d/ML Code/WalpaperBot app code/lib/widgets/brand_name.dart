...
Widget BrandName(){
  ...
  const Text.rich(TextSpan(
    text: "Wallpaper",style: TextStyle(color: Colors.blueAccent,fontWeight: FontWeight.bold),
      children: [
      TextSpan(text: "Bot",style: TextStyle(color: Colors.red,fontWeight: FontWeight.bold),
      )
  ]
  ));
